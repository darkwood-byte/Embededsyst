...
int main() {
    ...
    while (1) {
        ...
        ssd1306_printf(0, 1, "Mode: %d", volume);
        ssd1306_printf(0, 2, "Delta: %d", volume);
        ssd1306_printf(0, 3, "WIFI status: %d", volume);
        ssd1306_update();    
